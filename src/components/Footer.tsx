        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.about')}</a></li>
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.careers')}</a></li>
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.press')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.help')}</a></li>
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.safety')}</a></li>
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.contact')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.terms')}</a></li>
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.privacy')}</a></li>
              <li><a href="#" className={`text-gray-400 hover:text-white transition-colors ${isRTL ? 'font-cairo' : 'font-inter'}`}>{t('footer.cookies')}</a></li>
            </ul>
          </div>
        </div>
